...
Root *CMakeLists.txt* file::
  ...
  project(burgers_generalised-Example VERSION X.Y.Z LANGUAGES C Fortran)
...
*src/fortran/CMakeLists.txt* file::
  ...
  add_executable(burgers_generalised burgers_generalised.F90)
  ...
  target_link_libraries(burgers_generalised PUBLIC opencmisslibs mpi)
